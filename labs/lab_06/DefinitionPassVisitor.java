public class DefinitionPassVisitor implements ASTVisitor<Void> {
    ...
    public Void visit(VarDef varDef) {
        ...
        switch (symbol.getType().getName()) {
            ...
            case "Bool":
                break;
            default:
                ASTVisitor.error(id.getToken(), type.getToken().getText() + " not found.");
                return null;
        }
    ...
    public Void visit(FuncDef funcDef) {
        ...
        // TODO 1: Reținem informația de tip în simbolul nou creat.
        functionSymbol.setType(new TypeSymbol(type.getToken().getText()));

        // Căutăm tipul funcției.
        switch (functionSymbol.getType().getName()) {
            case "Int":
                break;
            case "Float":
                break;
